...
if(isset($_POST['insert_pro'])){
    ...
    $b_title = $_POST['brand_title'];
    $insert_product = "insert into brands (brand_title) VALUES ('$b_title');";
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="pro_title" name="brand_title" placeholder="Enter Product Brand" >
                </div>
            </div>
